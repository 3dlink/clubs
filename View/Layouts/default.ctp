...
<body>
	<div id="container">
		<div id="header">
			...
			<div onclick="window.location.href='<?php echo $this->webroot;?>#haka'" class="menu_item menu_web ap_men">APPLY</div>
			<div onclick="window.location.href='<?php echo $this->webroot;?>#whats'" class="menu_item menu_web wh_men">WHAT IS FAN PASS</div>
